...
(function ($) {
    ...
    MbComingsoon = function (element, opt) {
        ...
        if (jQuery.isFunction(opt.callBack))
            ...
            this.callBack = null;
        this.localization = {years:"years", days:"days", hours: "hours", minutes: "minutes", seconds: "seconds"};
...
result.years.units = yearrest % 10;
    ...
    jQuery.fn.mbComingsoon = function (opt) {
        var defaults = {
            interval: 1000,
            callBack: null,
            localization: { years: "years", days: "days", hours: "hours", minutes: "minutes", seconds: "seconds" },
            speed:500
        }
        var options = {};
